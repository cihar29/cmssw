...
DefaultHistoDigiCluster=DefaultHisto.clone( topFolderName= cms.string("PixelPhase1/Phase1_MechanicalView") )

DefaultHistoSummary=DefaultHisto.clone( topFolderName= cms.string("PixelPhase1/Summary") )

DefaultHistoTrack=DefaultHisto.clone( topFolderName= cms.string("PixelPhase1/Tracks") )

DefaultHistoReadout=DefaultHisto.clone( topFolderName= cms.string("PixelPhase1/FED/Readout") )
